...
select is(public.keel_cash_flow('00000000-0000-4000-8000-00000000a001','2026-06-01','2026-06-30')->>'formulaVersion','cash-flow-v2-settlement-excluded','cash_flow formula version reflects the exclusion');
