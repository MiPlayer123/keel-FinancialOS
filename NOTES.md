...
- **Base note**: branch rebased onto `origin/main` (my base 768bf7f carried a since-reverted nullable-split type that broke `reports/page.tsx`; origin/main has `categoryLedgerAccountId: string`, so no unrelated patch needed).
