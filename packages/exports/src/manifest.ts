...
export const INCLUDE = [
  ...
  include({ schema: 'public', table: 'transaction_categories', columns: ['canonical_transaction_id', 'household_id', 'category_ledger_account_id', 'source', 'created_at', 'updated_at'], sortKey: ['canonical_transaction_id'], timestampColumns: ['created_at', 'updated_at'], bigintColumns: [] }),
