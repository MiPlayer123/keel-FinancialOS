...
export const INCLUDE = [
  ...
  include({ schema: 'public', table: 'category_rules', columns: ['id', 'household_id', 'entity_id', 'matcher', 'pattern', 'category_ledger_account_id', 'rename_to', 'priority', 'active', 'created_at', 'updated_at'], sortKey: ['id'], timestampColumns: ['created_at', 'updated_at'], bigintColumns: [] }),
  ...
  include({ schema: 'public', table: 'scheduled_transactions', columns: ['id', 'household_id', 'account_id', 'description', 'amount_minor', 'currency', 'category_ledger_account_id', 'frequency', 'next_due_date', 'auto_enter_days', 'status', 'created_at'], sortKey: ['id'], timestampColumns: ['created_at'], bigintColumns: ['amount_minor'] }),
  include({ schema: 'public', table: 'savings_goals', columns: ['id', 'household_id', 'name', 'target_minor', 'target_date', 'account_id', 'currency', 'status', 'created_at'], sortKey: ['id'], timestampColumns: ['created_at'], bigintColumns: ['target_minor'] }),
  ...
  include({ schema: 'public', table: 'paychecks', columns: ['id', 'household_id', 'employer_id', 'pay_date', 'gross_minor', 'net_minor', 'currency', 'status', 'formula_version', 'created_by', 'created_at', 'updated_at'], sortKey: ['id'], timestampColumns: ['created_at', 'updated_at'], bigintColumns: ['gross_minor', 'net_minor'] }),
