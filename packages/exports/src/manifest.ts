...
export const EXCLUDE = [
  ...
  { schema: 'public', table: 'documents', reason: 'Export layer pending — attach-only receipts substrate shipped 2026-07-17 without export wiring (Law 6 gap tracked in NOTES.md); flip to INCLUDE when the layer ships.' },
  { schema: 'public', table: 'document_versions', reason: 'Export layer pending — attach-only receipts substrate shipped 2026-07-17 without export wiring (Law 6 gap tracked in NOTES.md); flip to INCLUDE when the layer ships.' },
  { schema: 'public', table: 'document_attachments', reason: 'Export layer pending — attach-only receipts substrate shipped 2026-07-17 without export wiring (Law 6 gap tracked in NOTES.md); flip to INCLUDE when the layer ships.' },
