...
export const INCLUDE = [
  ...
  include({ schema: 'public', table: 'holdings', columns: ['id', 'household_id', 'account_id', 'as_of', 'symbol', 'name', 'qty', 'price_minor', 'value_minor', 'cost_basis_minor', 'currency', 'source', 'created_at', 'updated_at'], sortKey: ['id'], timestampColumns: ['created_at', 'updated_at'], bigintColumns: ['price_minor', 'value_minor', 'cost_basis_minor'] }),
  ...
  include({ schema: 'public', table: 'investment_sync_state', columns: ['connection_id', 'household_id', 'last_pulled_through', 'last_synced_at', 'created_at', 'updated_at'], sortKey: ['connection_id'], timestampColumns: ['last_synced_at', 'created_at', 'updated_at'], bigintColumns: [] }),
] as const;
