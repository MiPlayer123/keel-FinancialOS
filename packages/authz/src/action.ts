...
export const ACTION_MINIMUM_ROLES = {
  ...
  'statements.create':'partner','statements.approve_draft':'partner','statements.dismiss_draft':'partner','statements.set_cadence':'partner','statements.decide_payment_link':'partner','statements.detach_payment_link':'partner','reconciliations.close':'partner','reconciliations.reopen':'partner',
